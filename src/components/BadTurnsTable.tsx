import type { BadTurn, Phase } from "../types";
...
/** Circling that wastes height/time: >1 full turn without climbing. */
export function BadTurnsTable({
  badTurns,
  fmt,
  tz,
  selected,
