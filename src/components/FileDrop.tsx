...
interface Props {
  ...
  onSample: () => void;
  /** Compact variant for the header (after a flight is loaded). */
  compact?: boolean;
  error?: string | null;
}

/** Drag-and-drop / click file picker for IGC / GPX / KML tracks. */
    ...
    <div className="filedrop-wrap">
      ...
      >
        ...
        <div className="filedrop-sub">
          or click to browse · <code>.igc</code> <code>.gpx</code>{" "}
          <code>.kml</code>
        </div>
        <input
          ref={inputRef}
