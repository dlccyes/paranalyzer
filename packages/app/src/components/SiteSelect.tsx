          ...
          <div className="sheet" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="sheet-scroll">
              {sites.map((s, i) => (
                <div key={s} className="col-row">
                  ...
                  <div className="col-reorder">
                    <button className="btn btn-xs btn-ghost" onClick={() => { setEditingIdx(i); setEditValue(s); }}>✏️</button>
                    <button className="btn btn-xs btn-ghost" style={{ color: "var(--clr-danger)" }} onClick={() => handleRemove(s)}>✕</button>
                  </div>
                </div>
              ))}
              <div className="site-add-row">
                ...
                />
                <button className="btn btn-sm" onClick={handleAdd} disabled={!newSiteName.trim()}>Add</button>
              </div>
            </div>
          </div>
        </div>
